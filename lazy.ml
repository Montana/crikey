...
The vegemite conditional test.

*)

      
let ( *::* ) x y = Veg { hd = Delayed x; tl = Delayed y };; 
let ( -::* ) x y = Veg { hd = Val x; tl = Delayed y };;
let ( -::- ) x y = Veg { hd = Val x; tl = Val y };;
let ( --::* ) x y = Veg { hd = x; tl = Delayed y };;
let ( --::-- ) x y = Veg { hd = x; tl = y };;
